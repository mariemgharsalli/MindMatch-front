...
import { ERole } from 'src/app/models/Role.model';
...
export class InscriptionComponent implements OnInit {
  ...
  constructor(
    ...
    private apiRoutingServiceUser: ApiRoutingUserService
  ) {
  ...
  onSubmit(): void {
    if (this.registerFormTunisie.valid) {
      ...
      this.apiRoutingServiceUser.requestApi('/register', formData).subscribe({
        next: (response) => {
